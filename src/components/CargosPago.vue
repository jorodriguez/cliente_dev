<template>
  <div id="id_tabla_cargos">
    ...
    <table class="table">
      ...
      <tbody v-for="row in listaCargosAlumnos" :key="row.id">
        <tr>
          ...
          <td>
            <span class="small">{{row.fecha_format}}</span>
          </td>
          <td>
    ...
    <!-- PAGO -->
    <Popup id="modal_pago" size="md" show_button_close="true">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="text-wrap" style="width: 10rem;">
                  <small 
                  :class="cargoSeleccionado.pagado ? 'tachado':''" 
                  >{{cargoSeleccionado.nota}}</small>
                </div>
              </td>              
              <td>
       ...
       <!--  <table class="table">
          ...
          <tr>
            ...
            <td>
              ...
              >{{cargoSeleccionado.cantidad > 1 ? cargoSeleccionado.cantidad:""}} {{cargoSeleccionado.nombre_cargo}} {{cargoSeleccionado.texto_ayuda != null ? cargoSeleccionado.texto_ayuda:'' }}</span>
              <div>
              <small>{{cargoSeleccionado.nota}}</small>
              </div>
            </td>
          </tr>
          <tr>
